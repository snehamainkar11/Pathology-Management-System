...
Public Class PurDetailsRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pathology.PurDetailsRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPurDetailsRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurDetailsRpt = New PurDetailsRpt
        rpt.Site = Me.Site
        Return rpt
    End Function
